...
iDRAC-SMIv1.mib   Integrated Dell Remote Access Controller
      - Provides detailed information about the SNMP data and traps that are supported by iDRAC7 and later versions.
      - This MIB file is written in "SMv1" notation/format.

iDRAC-SMIv2.mib   Integrated Dell Remote Access Controller
      - Provides detailed information about the SNMP data and traps that are supported by iDRAC7 and later versions.
...
Copyright © 2020 Dell Inc. All rights reserved. This product is 
